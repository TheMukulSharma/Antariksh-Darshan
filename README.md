...
+------------------------------------------------+
|     Thursday July 23, 2026 — 07:56 PM IST      |
|                  Delhi,India                   |
|                    28°,77°                     |
+------------------------------------------------+

MOON [VISIBLE]
   |-- Altitude :   36.5° above horizon
   |-- Direction:  184.9° (S)
   |-- Distance : 0.003 AU (399,433 km)
   |-- Phase    : 70.4% Illumination

MERCURY [BELOW HORIZON]

VENUS [VISIBLE]
   |-- Altitude :   21.8° above horizon
   |-- Direction:  265.3° (W)
   |-- Distance : 0.867 AU (129,746,417 km)
